...
def convert_all_svg_to_png(svg_dir, output_dir, size=128):
    """Konverterer alle SVG-filer til PNG med spesifisert størrelse"""
...
def main():
    ...
    print("🚀 STARTER KOMPLETT FLAGGOPPGRADERING")
    print("=" * 60)
    
    # Steg 1: Backup gamle flagg
    backup_dir = backup_old_flags()
    
    # Steg 2: Konverter alle SVG til PNG
    ...
    # Steg 3: Erstatt alle flagg
    replace_all_flags(output_dir)
    
    # Steg 4: Oppdater countries_data.json
    update_all_flag_files()
    
    print("\n" + "=" * 60)
    print("🎉 KOMPLETT FLAGGOPPGRADERING FULLFØRT!")
    print("=" * 60)
    print(f"✅ {successful} nye flagg konvertert")
