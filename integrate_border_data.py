#!/usr/bin/env python3
"""
Integrate border data from country-borders CSV into countries_data.json
"""
...
def integrate_border_data():
    ...
    print("🗺️ INTEGRERER NABOLAND-DATA")
    print("=" * 40)
    ...
    try:
        ...
        with open('country-borders.csv', 'r', encoding='utf-8') as f:
            ...
            for row in reader:
                ...
                borders[country_code].append(border_name)
        
        print(f"✅ Lastet naboland-data for {len(borders)} land")
        
        # Create a mapping from country names to ISO codes
        name_to_iso = {}
        for country in countries:
            name_to_iso[country['name']] = country['iso3']
            ...
            for country in countries:
                if country['name'] == example_name:
                    ...
                    if is_island:
                        ...
                        print(f"   {example_name}: {', '.join(borders)}")
                    break
